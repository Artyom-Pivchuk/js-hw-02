...
console.log('Вызов checkFruit("plum") возвращает:');
checkFruit("plum");
console.log('Вызов checkFruit("mandarin") возвращает:');
checkFruit("mandarin");
console.log('Вызов checkFruit("pear") возвращает:');
checkFruit("pear");
console.log('Вызов checkFruit("Pear") возвращает:');
checkFruit("Pear");
console.log('Вызов checkFruit("apple") возвращает:');
checkFruit("apple");