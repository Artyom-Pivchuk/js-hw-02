...
console.log('Вызов функции calculateTotalPrice([12, 85, 37, 4]) возвращает:', calculateTotalPrice([12, 85, 37, 4]));
console.log('Вызов функции calculateTotalPrice([164, 48, 291]) возвращает:', calculateTotalPrice([164, 48, 291]));
console.log('Вызов функции calculateTotalPrice([412, 371, 94, 63, 176]) возвращает:', calculateTotalPrice([412, 371, 94, 63, 176]));